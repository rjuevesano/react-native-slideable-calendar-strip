...
class DateItem extends PureComponent {
  render() {
    ...
    const isAdvanceDate = item >= now_date;
    // const highlightBgColor = '#6E99F1';
    const highlightBgColor = "#D1E8DF";
    const normalBgColor = "white";
    // const hightlightTextColor = '#fff';
    const hightlightTextColor = "#000";
        ...
        >
          <View
            style={[
              ...
              {
                backgroundColor: isAdvanceDate
                  ? normalBgColor
                  : highlightBgColor
              },
              { borderColor: "#e2e2e2", borderWidth: isAdvanceDate ? 1 : 0 }
            ]}
          >
            <Text style={[styles.itemDateText, { color: "#000" }]}>
              {solar}
            </Text>
          </View>
        </TouchableOpacity>
